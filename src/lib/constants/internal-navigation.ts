...
const ADMIN_NAV: readonly InternalNavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Assign clients and jobs to lead recruiters.',
        icon: 'assignments',
      },
      {
        label: 'Recruiter Allocation',
        href: APP_ROUTES.internal.assignments.lead,
        description: 'Assign jobs to recruiters and rebalance load.',
        icon: 'assignments',
      },
      {
        label: 'Jobs',
      ...
      },
      {
        ...
        description: 'Track applications and stage movement.',
        icon: 'applications',
      },
      {
        label: 'Review Queue',
